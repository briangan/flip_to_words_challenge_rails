module FlipToWords
  class FlipLettersController < ApplicationController
    ...
    def index
      map = FlipToWords::FlipLetterMap.load_from_file
      @flip_letters = map.map
      if params[:letter]
        @letter = params[:letter]
        @positions = map[@letter]
      end
      render template: "flip_to_words/flip_letters/index"
    end
    ...
    def show
      ...
      respond_to do |format|
        ...
        format.turbo_stream {
          render turbo_stream: turbo_stream.replace("letter_form", partial: "flip_to_words/flip_letters/form", locals: { letter: @letter, positions: @positions })
        }
      end
    end
    ...
    def authenticate_user!
      ...
      unless allowed_to_manage_flip_letters?
        ...
        respond_to do |format|
          ...
          format.html { render template: "flip_to_words/flip_letters/index", status: :unauthorized }
        end
      end
    end
  end
